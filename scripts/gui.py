...
#    Aug 15, 2019 03:28:33 PM CEST  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        #print(len(image))
        #nd = self.resultsScrolledtreeview.item(image)
        #n_text = nd['text']
        #print(n_text)
        #print(self.resultsScrolledtreeview.item()
        ...
        #added : changing as top layer otherwise wont recognize
        #self.dragAndDropImageLabel = tk.Label(self.dragAndDropFrame)
        self.dragAndDropImageLabel = tk.Label(top)
        #self.dragAndDropImageLabel.place(relx=0.029, rely=0.056, height=321
        #        , width=329, bordermode='ignore')
